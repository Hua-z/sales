...
<!--文件体开始-->
		...
		<tr>
			...
			<input type="button" value="删除" onclick="javascript:window.location='user/orderRemove?id=${order.id }';">&nbsp;
			<input type="button" value="明细" onclick="javascript:window.location='user/orderInfo?id=${order.id }';">
			</td>
		</tr>
		</c:forEach>
