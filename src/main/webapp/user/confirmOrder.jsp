...
<!--文件尾开始-->
		...
		<tr>
			...
			<font color="#ffffff"><b>商品购物清单</b></font><input type="button" value="修改" onclick="javascript:window.location='user/shoppingCart.jsp';"></td>
		</tr>
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="user/productDetail?id=1" target="_blank">${line.value.book.name}</a></td>
			...
			<td class=tablebody2 valign=middle align=left width="">小计：￥${line.value.book.price*line.value.num}</td>
		</tr>
        </c:forEach>
