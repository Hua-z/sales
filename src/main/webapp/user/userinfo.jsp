...
<!--文件体开始-->
		...
		<td height=25 valign=middle>
                  ...
                  <a href=index.jsp>图书销售系统</a> → 用户信息修改
                </td>
                </tr>
		</table>
              <br>
...
<form method="post" name="reg" action="user/customerUpdate">
	<table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
		...
		<tr>
			...
			<td width="60%" class="tablebody1">
			<input type="password" maxLength="8" size="32" name="password" value="" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">
			<font color="#FF0000">*</font></td>
		</tr>
		<tr>
			<td width="40%" class="tablebody1"><b>密码(至少6位，至多8位)</b>：<br>
